...
class StaffRecipeItem(models.Model):
    ...
    serving_qty = models.CharField(null=True, blank=True, max_length=100)
    serving_info = models.CharField(null=True, blank=True, max_length=255)
    serving_unit = models.CharField(max_length=100, null=True, blank=True)
    serving_weight_grams = models.CharField(max_length=100, null=True, blank=True)
    ...
    saturated_fat = models.CharField(max_length=100, null=True, blank=True)
...
class FoodSuggestion(models.Model):
    ...
    name = models.CharField(max_length=255)
    serving_info = models.CharField(max_length=255, null=True, blank=True)
    image = models.TextField(null=True, blank=True)
    calories = models.FloatField(default=0)
    protein = models.FloatField(default=0)
    carbs = models.FloatField(default=0)
...
class LoggedMealItem(models.Model):
    ...
    fats = models.FloatField(default=0)
    date = models.DateField(auto_now_add=True)
    logged_serving_qty = models.FloatField(null=True, blank=True)
